...
namespace INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20241221221648_MockTables")]
    partial class MockTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("INFRASTRUCTURE.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Admin",
                            Password = new byte[] { 178, 204, 120, 255, 248, 91, 192, 56, 237, 68, 148, 145, 78, 222, 26, 164, 179, 226, 64, 185, 18, 151, 69, 161, 225, 65, 227, 55, 103, 166, 213, 38 },
                            PasswordSalt = new byte[] { 239, 190, 157, 89, 201, 238, 243, 218, 251, 243, 30, 49, 143, 64, 58, 221 },
                            Surname = "Admin",
                            UserType = 0,
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Waiter",
                            Password = new byte[] { 154, 26, 221, 0, 20, 214, 176, 191, 50, 170, 213, 131, 208, 88, 41, 198, 84, 44, 235, 156, 92, 101, 119, 51, 197, 154, 95, 212, 165, 248, 99, 66 },
                            PasswordSalt = new byte[] { 220, 99, 18, 226, 164, 9, 143, 169, 36, 16, 149, 251, 44, 164, 170, 94 },
                            Surname = "Waiter",
                            UserType = 1,
                            Username = "waiter"
                        });
