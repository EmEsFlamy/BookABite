...
export class MenuComponent implements OnInit {
  ...
  categories = [
    { name: 'Food', icon: 'custom-food:antd' },
    { name: 'Drink', icon: 'coffee' },
    { name: 'Soup', icon: 'appstore' }
  ];
  ...
  soupItems = [
    { name: 'Tomato Soup', price: '$4.50' },
    { name: 'Chicken Soup', price: '$5.50' }
  ];

  selectedItems = this.foodItems;
  ...
  onCategoryChange(index: number): void {
    switch (index) {
      case 0:
        this.selectedItems = this.foodItems;
        break;
      case 1:
        this.selectedItems = this.drinkItems;
        break;
      case 2:
        this.selectedItems = this.soupItems;
        break;
    }
  }
